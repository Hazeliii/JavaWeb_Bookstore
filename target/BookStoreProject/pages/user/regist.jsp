	...
	<script type="text/javascript">
		...
		$(function (){
			...
			$("#username").blur(function (){
				...
				$.getJSON("http://localhost:8085/BookStoreProject/userServlet", "action=ajaxUserExist&username="+username,
						function (data){
					if(data.usernameIsExisted){
...
<body>
		<div id="login_header">
			<img class="logo_img" alt="" width="300px" height="80px" src="static/img/logo.png" >
		</div>
